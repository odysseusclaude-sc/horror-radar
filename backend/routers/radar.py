...
OPS_COMPONENT_META = [
    ...
    },
    {
        ...
        "weight": 0.08,
        "color": "#34d399",
        "desc": "Positive review ratio vs peer median",
        "formula": "review_score_pct / peer_median_sentiment",
    },
    {
        "key": "twitch",
        "db_field": "twitch_component",
        "label": "TWITCH ENGAGEMENT",
        "max": 5.0,
        "weight": 0.06,
        "color": "#818cf8",
        "desc": "Peak Twitch viewers vs peer median",
        "formula": "(peak_twitch_viewers / peer_median_twitch) x age_decay",
    },
]
